    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="flex items-center justify-center p-8 bg-canvas">
        <motion.div initial={{opacity:0,y:16}} animate={{opacity:1,y:0}} className="w-full max-w-sm">
          <div className="lg:hidden flex items-center gap-2 mb-6"><Mark size={30}/><span className="font-extrabold lowercase tracking-tight">kogia <span className="text-sm font-normal" style={{color:'#6C5CE7'}}>edu</span></span></div>
          ...
          <div className="space-y-3">
            ...
            <Btn size="lg" className="w-full" onClick={go} style={{background:'#6C5CE7'}}>Se connecter</Btn>
          </div>
