    ...
    <div className="bg-white text-ink">
      ...
      <section className="mx-auto max-w-[1120px] px-5 py-16">
        <motion.div {...up} className="rounded-3xl p-10 md:p-14 text-center text-white relative overflow-hidden" style={{background:'linear-gradient(135deg,#7539E4,#22D3EE)'}}>
          ...
          <p className="mt-3 text-white/85 max-w-[54ch] mx-auto">Ouvrez l’application avec le compte parent : un enfant en crèche, un enfant en 5ème : une seule application. Tout est là.</p>
          <button onClick={()=>nav('/login')} className={`${BTN_LG} mt-7 bg-white shadow-sm hover:opacity-90`} style={{color:A}}>Ouvrir l’application <ArrowRight size={18}/></button>
        </motion.div>
      </section>
