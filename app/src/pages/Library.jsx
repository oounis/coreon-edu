...
export default function Library(){
  ...
  return (<>
    <PageHead title={t('Bibliothèque')} sub={`${d.books.length} titres`}/>
    {d.books.length===0 ? <SectionCard headless bodyClass=""><EmptyState icon={<BookMarked size={26}/>} title={t('Aucun livre')} sub={t('Le catalogue de la bibliothèque est vide pour le moment.')}/></SectionCard>
