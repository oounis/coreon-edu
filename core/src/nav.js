...
const ALL_NAV=[
  ...
  { to:'/app/staff', section:'equipe', label:'Personnel', icon:'BriefcaseBusiness', roles:['schooladmin','hr'] },
  // RH & paie : aucune école n'achète un ERP sans ça. Ennuyeux, donc parfait.
  { to:'/app/hr', section:'equipe', label:'RH & Paie', icon:'Wallet2', module:'hr', pinned:['hr'], roles:['schooladmin','hr'] },
  ...
  { to:'/app/accounting', section:'argent', label:'Comptabilité', icon:'Receipt', module:'accounting', pinned:['accountant'], roles:['schooladmin','accountant'] },
  ...
  { to:'/app/finance', section:'argent', label:'Frais & Finances', icon:'Wallet', roles:['schooladmin','accountant'] },
