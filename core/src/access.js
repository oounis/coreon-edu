...
export const ROUTE_ROLES={
  ...
  '/app/pointage': ['teacher','supervisor','security','admin','hr','accountant'],
  ...
  '/app/social': ['parent','teacher','supervisor','security','schooladmin','admin','hr','accountant'],
  ...
  '/app/requests': ['teacher','admin','schooladmin','hr','accountant','supervisor','security'],
  '/app/messages': ALL,
  '/app/notices': ALL,
