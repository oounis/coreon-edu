...
M = [  # (module, rôle, tests, manques/bugs clés, prep 1-5, priorité, statut)
 ...
 ('audit.js','CR-039 · journal d’audit : qui a lu / modifié un dossier sensible','9 tests cœur (falsification, rotation comptée, purge non destructrice, injection CSV) + e2e/parcours.audit.mjs','AJOUTÉ 2026-08-01. Clé de stockage séparée du blob (sinon mergeWrite le rendrait réécrivable) ; chaîne d’empreintes tamper-ÉVIDENTE, pas tamper-proof ; aucun chemin de suppression. RESTE : immuabilité réelle = table serveur en AJOUT SEUL (D9)',4,'P1','LIVRÉ 2026-08-01 (CR-039)'),
